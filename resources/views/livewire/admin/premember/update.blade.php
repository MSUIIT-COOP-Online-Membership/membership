<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('UpdateTitle', ['name' => __('Premember') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <form class="form-horizontal" wire:submit.prevent="update" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                <label for='input-fname' class='col-sm-2 control-label '> {{ __('Fname') }}</label>
            ...
            <!-- Mname Input -->
            <div class='form-group'>
                <label for='input-mname' class='col-sm-2 control-label '> {{ __('Mname') }}</label>
            ...
            <!-- Lname Input -->
            <div class='form-group'>
                <label for='input-lname' class='col-sm-2 control-label '> {{ __('Lname') }}</label>
            ...
            <!-- Gender Input -->
            <div class='form-group'>
                <label for='input-gender' class='col-sm-2 control-label '> {{ __('Gender') }}</label>
            ...
            <!-- Date_of_birth Input -->
            <div class='form-group'>
                <label for='input-date_of_birth' class='col-sm-2 control-label '> {{ __('Date_of_birth') }}</label>
            ...
            <!-- Civil_status Input -->
            <div class='form-group'>
                <label for='input-civil_status' class='col-sm-2 control-label '> {{ __('Civil_status') }}</label>
            ...
            <div class='form-group'>
                <label for='input-telephone_number' class='col-sm-2 control-label '> {{ __('Telephone_number') }}</label>
            ...
            <!-- Mobile_number Input -->
            <div class='form-group'>
                <label for='input-mobile_number' class='col-sm-2 control-label '> {{ __('Mobile_number') }}</label>
            ...
            <div class='form-group'>
                <label for='input-facebook_account' class='col-sm-2 control-label '> {{ __('Facebook_account') }}</label>
            ...
            <div class='form-group'>
                <label for='input-present_address' class='col-sm-2 control-label '> {{ __('Present_address') }}</label>
            ...
            <div class='form-group'>
                <label for='input-ofw_family_member' class='col-sm-2 control-label '> {{ __('Ofw_family_member') }}</label>
            ...
            <!-- Occupation Input -->
            <div class='form-group'>
                <label for='input-occupation' class='col-sm-2 control-label '> {{ __('Occupation') }}</label>
