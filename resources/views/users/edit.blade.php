                        ...
                        <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select id="role" name="role" class="form-control" required>
                                    ...
                                    <option value="Regular Member" {{ $user->role == 'Regular Member' ? 'selected' : '' }}>Regular Member</option>
                                    <option value="Vice-Chairperson" {{ $user->role == 'Associate Member' ? 'selected' : '' }}>Associate Member</option>
                                </select>
                            </div>
