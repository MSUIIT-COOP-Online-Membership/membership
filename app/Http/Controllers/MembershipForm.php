...
class MembershipForm extends Controller
{
    public function index()
    {
        return view('forms.code');
    }

    public function code(Request $request)
    {
        $code = $request->input('code');
        $members = Members::find($code);

        if (!$members) {
            return view('forms.index')->with('error', 'Item not found.');
        }

        return view('forms.membership', ['members' => $members]);
    }
    ...
    public function view(int $id)
    {
        ...
        $beneficiaries = Beneficiaries::where('member_id', $id)->get();
        return view('forms.view', ['members' => $members], ['beneficiaries' => $beneficiaries]);
    }
    ...
    public function viewPDF(int $id)
    {
        $members = Members::findOrfail($id);
        $beneficiaries = Beneficiaries::where('member_id', $id)->get();
        return view('forms.pdf_download.pdf_view', ['members' => $members], ['beneficiaries' => $beneficiaries]);
    }
    ...
    public function generatePDF(int $id)
    {
        ...
        // Load HTML content
        $html = view('forms.pdf_download.pdf_view', $data)->render();
