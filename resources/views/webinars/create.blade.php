...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('Add Webinar') }}</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('webinars.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="resource_speaker" class="form-control @error('resource_speaker') is-invalid @enderror" name="resource_speaker" required>{{ old('resource_speaker') }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="web_link" type="url" class="form-control @error('web_link') is-invalid @enderror" name="web_link" value="{{ old('web_link') }}">
